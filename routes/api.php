...
/*
 * Public JSON API. Machine-readable contract: GET /api/openapi.json (docs/api.json).
 * GET /api/openai.json is a spelling alias and returns the same document.
 */
...
Route::prefix('')->middleware([])->group(function () {
    ...
    Route::post('user/register/request', [UserAuthProxyController::class, 'registerResumeRequest']);
